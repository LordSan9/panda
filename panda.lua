...
if hash or pandaDevSou(msg) then  
return true  
else  
return false  
end  
...
if hash or Bot(msg) or Devpanda(msg) or pandaDevSou(msg) then    
return true  
else  
return false  
end  
...
if hash or Devpanda(msg) or DevBot(msg) or pandaDevSou(msg) then     
return true 
else 
return false 
end 
...
if hash or Devpanda(msg) or DevBot(msg) or pandaDevSou(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Devpanda(msg) or DevBot(msg) or BasicConstructor(msg) or pandaDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Devpanda(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or pandaDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Devpanda(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or pandaDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  Devpanda(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or pandaDevSou(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
var = true
elseif pandaDevSou(user_id) == true then
var = true
...
local url,res = https.request('https://mode-pro.tk/xpandax/Johoin.php?id='..msg.sender_user_id_)
...
local UserName = (data.username_ or "panda_SoUrcE")
...
local panda_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if panda_Msg then    
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and pandaDevSou(msg) then
function Function_panda(extra, result, success)
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and pandaDevSou(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and pandaDevSou(msg) then
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and pandaDevSou(msg) then
function Function_panda(extra, result, success)
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and pandaDevSou(msg) then
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and pandaDevSou(msg) then
...
if text == ("مسح الثانويين") and pandaDevSou(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Devpanda(msg) then
function Function_panda(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and Devpanda(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and Devpanda(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local pandart = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if pandart == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "panda_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
...
if result.id_ then
local pandart = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if pandart == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..result.title_.."](t.me/"..(text1[3] or "panda_SoUrcE")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'panda_SoUrcE')..') ~'
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'panda_SoUrcE')..')'
status  = '\n• تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
*•●○●○●○●•ٴ*
𝘊𝘩 - [𝘯𝘪𝘨𝘨𝘢](http://t.me/panda_SoUrcE)•
]]
send(msg.chat_id_, msg.id_,Text)
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'panda_SoUrcE')..')'
...
local UserName = (b.username_ or "panda_SoUrcE")
...
if database:get(bot_id.."Status:Bc") and not Devpanda(msg) then 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝘕𝘐𝘎𝘎𝘈 - SoUrCe](https://t.me/panda_SoUrcE)
]]
...
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/panda/main/panda.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/panda/main/start.lua')
dofile('panda.lua')  
return false
end
if text == "راسلني" then
...
ge = https.request('https://mode-pro.tk/ageApi/pandaapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.Rt)
end
if text == 'السيرفر' and Devpanda(msg) then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•  𝘕𝘐𝘎𝘎𝘈  .',url="t.me/panda_SoUrcE"}},
}
local msg_id = msg.id_/2097152/0.5
...
if Devpanda(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/panda/files_panda/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/panda/files_panda/main/files_panda/"..file)
if res == 200 then
...
Text = "[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/panda_SoUrcE)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦 .',url="https://t.me/panda_Source/117"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if text == '@ZZZZD' or text == '@panda_SoUrcE' or text == 'مودي البدراني' then
Text = [[
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not Devpanda(msg) then
...
if not Devpanda(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if text =='تغيير المطور الاساسي •' and pandaDevSou(msg) then
send(msg.chat_id_, msg.id_,'• ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي •' and not pandaDevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and not pandaDevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and pandaDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
...
inline = {
{{text = '•  𝘕𝘐𝘎𝘎𝘈  .',url='http://t.me/panda_SoUrcE'}},
}
...
------------------------------------------------------------------------
if text then
local panda_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if panda_Msg then    
