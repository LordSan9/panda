...
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARICATEAM/pandaFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/LARICATEAM/pandaFiles/master/pandaFiles/"..FileName)
if Res == 200 then
